...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 swift app-ui --ckpt_dir '/home/zwmx/xm_dev/ls_project/llm_sft_output/qwen1half-14b-chat/v15-20240427-155823/checkpoint-3800' --merge_lora true --max_model_len=9000 --share True --server_name '0.0.0.0' --infer_backend vllm
