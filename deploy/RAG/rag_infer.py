...
llm = HuggingFaceLLM(
    ...
    tokenizer_name='/home/zwmx/xm_dev/ls_project/llm_sft_output/qwen1half-14b-chat/v2-20240420-081224/checkpoint-2826-merged',
    model_name='/home/zwmx/xm_dev/ls_project/llm_sft_output/qwen1half-14b-chat/v2-20240420-081224/checkpoint-2826-merged',
    device_map="auto",
...
#
documents = SimpleDirectoryReader('/home/zwmx/xm_dev/ls_project/dataset/tigerbot_law/data').load_data()
index = VectorStoreIndex.from_documents(documents, transformations=[SentenceSplitter(chunk_size=256)])

# 将embedding向量和向量索引存储到文件中
index.storage_context.persist(persist_dir='/home/zwmx/xm_dev/ls_project/swift/scripts/ls/deploy/RAG/doc_emb')
...
# 查询获得答案
response = query_engine.query("网购商品用快递送达，商品在快递途中、签收之前毁损的风险谁承担？")
print(response)
